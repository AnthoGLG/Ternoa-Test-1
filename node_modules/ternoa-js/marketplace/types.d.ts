...
export type SetFeeType = {
    [MarketplaceConfigAction.Set]: RequireOnlyOne<IFeeType>;
};
...
export type AccountListType = MarketplaceConfigAction.Noop | MarketplaceConfigAction.Remove | {
    [MarketplaceConfigAction.Set]: string[];
};
export type OffchainDataType = MarketplaceConfigAction.Noop | MarketplaceConfigAction.Remove | {
    [MarketplaceConfigAction.Set]: string;
};
export type CollectionListType = MarketplaceConfigAction.Noop | MarketplaceConfigAction.Remove | {
