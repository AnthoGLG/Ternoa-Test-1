...
import { AcceptanceAction, CancellationFeeAction, DurationAction, RentFeeAction, SubscriptionActionDetails } from "./enum";
...
export type DurationFixedType = {
    [DurationAction.Fixed]: number;
};
export type DurationSubscriptionType = {
    [DurationAction.Subscription]: DurationSubscriptionDetailsType;
};
export type DurationType = DurationFixedType | DurationSubscriptionType;
export type AutoAcceptanceType = {
    [AcceptanceAction.AutoAcceptance]: string[] | null;
};
export type ManualAcceptanceType = {
    [AcceptanceAction.ManualAcceptance]: string[] | null;
};
export type AcceptanceType = AutoAcceptanceType | ManualAcceptanceType;
export type RentFeeTokensType = {
    [RentFeeAction.Tokens]: number | BN;
};
export type RentFeeNFTType = {
    [RentFeeAction.NFT]: number;
};
export type RentFeeType = RentFeeTokensType | RentFeeNFTType;
export type CancellationFeeFixedTokensType = {
    [CancellationFeeAction.FixedTokens]: number | BN;
};
export type CancellationFeeFlexibleTokensType = {
    [CancellationFeeAction.FlexibleTokens]: number | BN;
};
export type CancellationFeeNFTType = {
    [CancellationFeeAction.NFT]: number;
};
export type CancellationFeeType = CancellationFeeAction.None | CancellationFeeFixedTokensType | CancellationFeeFlexibleTokensType | CancellationFeeNFTType;
