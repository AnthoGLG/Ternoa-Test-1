...
export declare enum chainQuery {
...
export declare enum chainConstants {
...
export declare enum Errors {
    ...
    NEXT_TEE_CLUSTER_UNDEFINED = "NEXT_TEE_CLUSTER_UNDEFINED",
